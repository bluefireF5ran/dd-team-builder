...
export const COMBAT_SKILL_EFFECTS = {
  "Abomination": {
    ...
    "Slam":          { type: "Melee", launch: "1·2·3", target: "1·2", move: -1, dmg: "-25%", acc: "100%", crit: "+5%", effect: "Knockback 2 (140% base), -20 DODGE (140% base, 4 rds), -6 SPD (140% base, 4 rds) | Self: Forward 1" },
  },
  "Antiquarian": {
    ...
    "Get Down!":             { type: "Self", launch: "1·2·3·4", target: "Self", move: 2, dmg: "-100%", acc: "1000%", crit: "+0%", effect: "Self: Back 2, +10% Blight Skill Chance, +15 DODGE, +1 SPD (4 rds)" },
  ...
  "Crusader": {
    ...
    "Holy Lance":          { type: "Melee", launch: "3·4", target: "2·3·4", move: -1, dmg: "+0%", acc: "105%", crit: "+10.5%", effect: "+35% DMG vs Unholy | Self: Forward 1" },
  ...
  "Duelist": {
    ...
    "Touché":         { type: "Melee", launch: "1·2·3·4", target: "1·2", move: 1, dmg: "+0%", acc: "110%", crit: "+5%", effect: "Stance: defensive | Self: +50 DODGE until next Dodge (4 rds)" },
    "Feint":          { type: "Melee", launch: "1·2·3", target: "1·2", dmg: "-50%", acc: "115%", crit: "+12%", effect: "Stance: defensive | Self: Mark | Self: Riposte: +35% DMG (4 rds) | -10 ACC vs Marked (150% base) (3 rds), -30% PROT (150% base) (3 rds)" },
    "Disengage":      { type: "Melee", launch: "1·2", target: "1·2", move: 3, dmg: "-50%", acc: "115%", crit: "+3%", effect: "Stance: defensive | Self: +10 ACC (4 rds), +8 SPD (4 rds), +40 DODGE if in position 4 (4 rds) | Self: Attacks usable in any position (2 rds), Attacks can target any position (2 rds)" },
    "Flèche":         { type: "Melee", launch: "2·3·4", target: "1·2·3", move: -2, dmg: "+25%", acc: "110%", crit: "+13%", effect: "Stance: aggressive | Self: Mark" },
    ...
    "The Boot":       { type: "Melee", launch: "1·2·3", target: "1·2", move: -1, dmg: "-40%", acc: "115%", crit: "+5%", effect: "Stance: aggressive | Stun (140% base) | Knockback 1 (150% base)" },
  },
  "Flagellant": {
  ...
  "Grave Robber": {
    ...
    "Lunge":             { type: "Melee", launch: "3·4", target: "1·2·3", move: -2, dmg: "+40%", acc: "115%", crit: "+12%", effect: "+33% DMG vs Blighted | Self: Forward 2" },
    ...
    "Shadow Fade":       { type: "Self", launch: "1·2", target: "Self", move: 2, dmg: "-100%", acc: "1000%", crit: "+0%", effect: "Self: Back 2, Stealth (2 rds), +100% DMG (2 rds), +8% CRIT (2 rds), +15 DODGE (4 rds)" },
  ...
  "Hellion": {
    ...
    "Breakthrough":     { type: "Melee", launch: "2·3·4", target: "1·2·3", aoe: true, move: -1, dmg: "-50%", acc: "105%", crit: "+3%", effect: "Self: Forward 1, -10% DMG, -1 SPD(3 rds)" },
  ...
  "Highwayman": {
    ...
    "Point Blank Shot":   { type: "Ranged", launch: "1", target: "1", move: 1, dmg: "+50%", acc: "115%", crit: "+9%", effect: "Knockback 1 (140% base) | Self: Back 1" },
    ...
    "Duelist's Advance":  { type: "Melee", launch: "2·3·4", target: "1·2·3", move: -1, dmg: "-20%", acc: "110%", crit: "+9%", effect: "Forward 1, Activates Riposte (3 rds), Riposte: [-15% DMG, +5% CRIT (3 rds)]" },
  ...
  "Jester": {
    "Dirk Stab":       { type: "Melee", launch: "1·2·3·4", target: "1·2·3", move: -1, dmg: "+0%", acc: "105%", crit: "+9%", effect: "Self: Forward 1, Bypass Guard, Finale: +30% DMG (8 rds)" },
    ...
    "Finale":          { type: "Melee", launch: "1·2", target: "1·2·3·4", move: 3, dmg: "+50%", acc: "160%", crit: "+9%", effect: "Self: Back 3, -25 DODGE, -3 SPD, +100% Stress(1 Battle), Limit:1 Use per Battle" },
    "Solo":            { type: "Ranged", launch: "3·4", target: "1·2·3", move: -3, dmg: "-100%", acc: "145%", crit: "+0%", effect: "Self: Forward 3, Mark Self (3 rds), +30 DODGE (4 rds), Finale: +75% DMG (8 rds), Finale: +8% CRIT (8 rds), Limit:2 Uses per Battle" },
  ...
  "Man at Arms": {
    ...
    "Rampart":      { type: "Melee", launch: "1·2·3", target: "1·2", move: -1, dmg: "-60%", acc: "110%", crit: "+9%", effect: "Knockback 1 (140% base), Stun (140% base) | Self: Forward 1" },
  ...
  "Runaway": {
    "Searing Strike":   { type: "Melee", launch: "1·2", target: "1·2·3", dmg: "+0%", acc: "105%", crit: "+6%", effect: "Burn 5 pts/rd | Self: +35% DMG vs Burning" },
    "Firefly":          { type: "Ranged", launch: "3·4", target: "2·3·4", dmg: "-75%", acc: "105%", crit: "+7%", effect: "Burn 9 pts/rd (140% base), +50% Burn Decay (140% base) (1 rds) | Self: +6 Torch" },
    "Run and Hide":     { type: "Ranged", launch: "1·2·3·4", target: "Self", move: 2, effect: "Self: Stealth (4 rds), Cannot be Stealthed while in position 1 (4 rds), Cannot be Stealthed while in position 2 (4 rds) | Self: Heal 5 pts/rd for 3 rds while Stealthed (3 rds)" },
    "Ransack":          { type: "Melee", launch: "1·2·3·4", target: "1·2·3·4", move: -1, dmg: "-10%", acc: "105%", crit: "+6%", effect: "Pull 1 (140% base) | Enemies: Clears corpses | Self: +10 ACC while Stealthed" },
    "Hearthlight":      { type: "Ranged", launch: "1·2·3·4", target: "1·2·3·4", aoe: true, dmg: "-100%", acc: "120%", crit: "+0%", effect: "Ignores Stealth | Removes Stealth | Self: +8 Torch | Party: +10 ACC (3 rds) | Party: +14% CRIT vs Burning (3 rds)" },
    "Controlled Burn":  { type: "Ranged", launch: "1·2·3", target: "1·2·3", dmg: "-100%", acc: "115%", crit: "+0%", effect: "Ignores Stealth | Self: +6 Torch | Burn 6 pts/rd | Controlled Burn 4 pts/rd for 3 rds | 2 uses per battle" },
  ...
  "Shieldbreaker": {
    "Pierce":        { type: "Melee", launch: "1·2·3", target: "1·2·3·4", move: -1, dmg: "-10%", acc: "110%", crit: "+9%", effect: "Armor Piercing | Self: Forward 1" },
    "Puncture":      { type: "Ranged", launch: "1·2·3·4", target: "1·2·3·4", move: -1, dmg: "-50%", acc: "110%", crit: "+0%", effect: "Bypass Guard / Break Guard, Can't be Guarded (500% base, 2 rds), Pull 2 (140% base), -3 SPD (140% base, 4 rds) | Self: Forward 1" },
    "Adder's Kiss":  { type: "Melee", launch: "1", target: "1·2", move: 1, dmg: "+0%", acc: "110%", crit: "+9%", effect: "Blight (140% base)5 pts/rd for 3rds | Self: Back 1" },
...
export const CAMP_SKILL_EFFECTS = {
  ...
  "Meditation":                { cost: 3, effect: "Self: +15 ACC while Riposte active | Self: +15 DODGE while Riposte active" },
  "Preparation":               { cost: 3, effect: "Self: +20% DMG on First Round | Self: +10 DODGE on First Round | Self: +2 SPD on First Round" },
  "Ruthless Instruction":      { cost: 2, effect: "+7% CRIT | +5 SPD | +10 Stress | (50% chance) +5 Stress" },
