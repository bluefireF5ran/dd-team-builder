...
export const MODDED_HERO_CLASSES = {
  ...
  'Librarian': {
    ...
    classSpecificTrinkets: [
      ...
      'A Shadows Tale',
      'Heike Monogatari',
      'Plague Priests Teachings',
      'Graveyard Keepers List of the Dead',
      'Moonlight Sonata'
    ]
  },
  'Link the Adventurer': {
