    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4">
      ...
      <div className="sm:col-span-2 lg:col-span-1">
        ...
        <select
          ...
          className="w-full bg-gray-800/80 text-dd-parchment px-3 sm:px-4 py-2 rounded border-2 border-gray-700 focus:border-dd-gold focus:outline-none transition-colors font-darkest text-lg sm:text-xl"
        >
          {LOCATIONS.map(loc => (
